    ...
    return (
      <div className='agecheck-body'>
        ...
        <div className='other-options'>
          ...
          <span>
            If you are unable to create a YOTI account, talk to a <a target='_blank' href='https://www.childline.org.uk/get-support/1-2-1-counsellor-chat/'>Childline counsellor</a> for further options of how to report your image or video.
          </span>
        </div>
        <Footer />
      </div>
