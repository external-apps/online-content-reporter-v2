  ...
  return (
    <div className='yoti-description-container'>
      ...
      <p className='yoti-instructions'>
        If not, it's easy to <a className='link' rel='external' target='_blank' href='https://app.adjust.com/3wwgmx_czq790?redirect=http%3A%2F%2Fyoti.com&campaign=NSPCC_LP&adgroup=report_image_online'>sign up</a> using the YOTI app or website. YOTI lets you safely share your details online - Just click below to create your account.
      </p>
    </div>
  )
}
